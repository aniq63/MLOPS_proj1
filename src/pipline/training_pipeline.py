...
class TrainPipeline:
    ...
    def start_model_trainig(self, data_transformation_artifact : DataTransformationArtifact):
        try:
            # Call the class
            model_training = ModelTrainer(data_transformation_artifact = data_transformation_artifact , model_training_config = self.model_training_config)
    ...
    def run_pipeline(self, ) -> None:
        ...
        try:
            ...
            model_training_artifact = self.start_model_trainig(data_transformation_artifact=data_transformation_artifact)
        except Exception as e:
            raise MyException(e, sys)